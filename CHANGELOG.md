...
- Added test coverage for the Falcon polynomial ring: degree and leading-coefficient edge cases, the cyclotomic reduction sign rule, the Galois adjoint and lift, the field norm, and Karatsuba against schoolbook multiplication ([#3550](https://github.com/0xMiden/miden-vm/pull/3550)).
